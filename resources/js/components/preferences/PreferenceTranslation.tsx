...
import { IPreference, IPreferenceDataTranslations, IPreferenceResponseItem, IPreferenceTranslations } from "@/types/Preference";
...
class PreferenceTranslation extends React.Component<IProps, IState>
{
                            ...
                            <div className="container-fluid p-0 mb-5">
                                <div className="row g-4">
                                    ...
                                    <div className="col-md-5 border-end p-5">
                                        <div className="mb-4">
                                            <h5 className="fw-bold text-dark">Preference item overview</h5>
    ...
    onSubmit = async(event: any) => {
        ...
        const data: IPreferenceDataTranslations = event;

        // for(let input in event.translations) {
        //     data[input] = event;
        // }
        Store.dispatch(enableLoading({}));
        const res= await PreferencesAPI.addOrEditTranslations(this.props.currentItem.id, data as IPreferenceDataTranslations);
        ...
        if(res && res.success == true)  {
            const responseData: IPreferenceResponseItem = res.data as IPreferenceResponseItem;
...
export default PreferenceTranslation;