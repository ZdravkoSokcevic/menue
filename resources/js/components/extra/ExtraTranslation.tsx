...
import { IExtra, IExtraDataTranslations, IExtraResponseItem, IExtraTranslations } from "@/types/Extra";
...
class ExtraTranslation extends React.Component<IProps, IState>
{
                        ...
                        <div className="container-fluid">
                            <div className="row">
                                ...
                                <div className="col-md-5 border-end p-5">
                                    <div className="mb-4">
                                        <h5 className="fw-bold text-dark">Extra item overview</h5>
    ...
    onSubmit = async(event: any) => {
        ...
        const data: IExtraDataTranslations = event;

        // for(let input in event.translations) {
        //     data[input] = event;
        // }
        Store.dispatch(enableLoading({}));
        const res= await ExtrasAPI.addOrEditTranslations(this.props.currentItem.id, data as IExtraDataTranslations);
        // debugger;
        ...
        if(res && res.success == true)  {
            const responseData: IExtraResponseItem = res.data as IExtraResponseItem;
