...
import { ICategory, ICategoryDataTranslations, ICategoryTranslations, TCategories } from "@/types/Categories";
...
class CategoryTranslation extends React.Component<IProps, IState>
{
    ...
    render(): React.ReactNode {
        ...
        // TODO: Modify this.props.currentItem.translations as IInitialValues expects
        // const initialValues = {translations : this.props.currentItem.translations} as IInitialValues;
                        ...
                        <div className="container-fluid">
                            <div className="row">
                                ...
                                <div className="col-md-5 border-end p-5">
                                    <div className="mb-4">
                                        <h5 className="fw-bold text-dark">Category item overview</h5>
    ...
    onSubmit = async(event: any) => {
        ...
        const data: ICategoryDataTranslations = event;

        // for(let input in event.translations) {
        //     data[input] = event;
        // }
        Store.dispatch(enableLoading({}));
        const res= await CategoriesAPI.addOrEditTranslations(this.props.currentItem.id, data as ICategoryDataTranslations);
        ...
        if(res && res.success == true)  {
            const responseData: ICategoryTranslations = res.data as ICategoryTranslations;
