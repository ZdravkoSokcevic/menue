...
import { IIngridient, IIngridientDataTranslations, IIngridientResponseItem, IIngridientTranslations } from "@/types/Ingridient";
...
class IngridientTranslation extends React.Component<IProps, IState>
{
    ...
    render(): React.ReactNode {
        ...
        // TODO: modify this.props.currentItem.translations as IInitialValues
                                ...
                                <div className="container-fluid p-0 mb-5">
                                    <div className="row g-4">
                                        ...
                                        <div className="col-md-5 border-end p-5">
                                            <div className="mb-4">
                                                <h5 className="fw-bold text-dark">Ingridient item overview</h5>
    ...
    onSubmit = async(event: any) => {
        ...
        const data: IIngridientDataTranslations = event;

        // for(let input in event.translations) {
        //     data[input] = event;
        // }
        Store.dispatch(enableLoading({}));
        const res= await IngridientsAPI.addOrEditTranslations(this.props.currentItem.id, data as IIngridientDataTranslations);
        ...
        if(res && res.success == true)  {
            const responseData: IIngridientResponseItem = res.data as IIngridientResponseItem;
...
export default IngridientTranslation;